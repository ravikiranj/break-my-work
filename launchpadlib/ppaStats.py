...
archs = ["i386"]
releases = ["lucid", "maverick", "natty", "oneiric", "precise", "quantal", "raring"]
releases.reverse()

if len(sys.argv) < 3:
    print "Usage: ppastats owner ppaname1 [ppaname2 ...] (Example: python ppastats.py ravikiran-j break-my-work)"
    sys.exit(1)
